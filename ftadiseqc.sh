...
rm -r $T1P1 $T1P2 $T1P3 $T1P4 $T2P1 $T2P2 $T2P3 $T2P4 $T3P1 $T3P2 $T3P3 $T3P4 $T4P1 $T4P2 $T4P3 $T4P4
mkdir $T1P1 $T1P2 $T1P3 $T1P4 $T2P1 $T2P2 $T2P3 $T2P4 $T3P1 $T3P2 $T3P3 $T3P4 $T4P1 $T4P2 $T4P3 $T4P4
	    echo '1' > $T1P1/N.txt
	    echo '1' > $T1P2/N.txt
	    echo '1' > $T1P3/N.txt
	    echo '1' > $T1P4/N.txt
